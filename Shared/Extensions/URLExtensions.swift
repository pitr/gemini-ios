...
extension URL {
    ...
    */
    ...
    public func isWebPage(includeDataURIs: Bool = true) -> Bool {
        let schemes = includeDataURIs ? ["gemini", "data"] : ["gemini"]
