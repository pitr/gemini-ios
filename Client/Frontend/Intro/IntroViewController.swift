...
class IntroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        main2panel.addArrangedSubview(topHolder)

        let bottomHolder = UIView()
        main2panel.addArrangedSubview(bottomHolder)

        [heading1, heading2].forEach {
            topHolder.addSubview($0)
        }
        [subtitlePage1, subtitlePage2, nextButton, startBrowsingButton].forEach {
            bottomHolder.addSubview($0)
        }

        heading1.text = Strings.CardTitleWelcome
        heading2.text = Strings.CardTitleNext
        ...
        subtitlePage2.text = Strings.CardTextNext
    ...
    @objc func nextTapped() {
        ...
        [startBrowsingButton, subtitlePage2, heading2].forEach {
            $0.alpha = 0
            $0.isHidden = false
        }
